...
func InitializeAPI(cfg config.Config) (*http.ServerHTTP, error) {
	...
	cardRepository := repository.NewCardRepository(gormDB)
	userUseCase := usecase.NewUserUseCase(userRepository, cardRepository)
	serverUseCase := usecase.NewServerUseCase(cardRepository, userRepository)
	userHandler := handler.NewUserHandler(userUseCase, serverUseCase)
